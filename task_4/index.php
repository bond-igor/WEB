...
$workExperience = [
    [
        ...
        'date' => "Jan 2019 - наст. время", 
        'description' => "Разработка серверной части сайтов на PHP"
    ],
    [
        'profession' => "Тестировщик", 
        'date' => "Dec 2016 - Nov 2018", 
        'description' => "Автоматизированое тестирование на Pyhton"
    ], 
    [
        'profession' => "Водитель", 
        'date' => "2008 - Dec 2016", 
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php for($i = 0; $i < count($workExperience); $i++): ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $workExperience[$i]['profession'];?> </b></h5>
